...
- Bump Native SDK from v0.7.19 to v0.8.1 ([#1](https://github.com/limbonaut/sentry-godot/pull/1))
  - [changelog](https://github.com/getsentry/sentry-native/blob/master/CHANGELOG.md#081)
  - [diff](https://github.com/getsentry/sentry-native/compare/0.7.19...0.8.1)
