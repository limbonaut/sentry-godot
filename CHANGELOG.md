...
- Bump Native SDK from v0.9.0 to v0.16.6 ([#5](https://github.com/limbonaut/sentry-godot/pull/5))
  - [changelog](https://github.com/getsentry/sentry-native/blob/master/CHANGELOG.md#0166)
  - [diff](https://github.com/getsentry/sentry-native/compare/0.9.0...0.16.6)
